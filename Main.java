...
public class Main {
    ...
    public static void survey() {
        ...
        if (letContinue == "yes" || letContinue == "y" || letContinue == "Yes") {
            ...
            int luckyNum = lucky.chart();
            if (lucky.charAt(1) >= 1) {
                luckyNum += 10;
                luckyNum += lucky.chartAt(1);
            }
            ...
            System.out.print("5/6 What is the first name of their favorite actor or actress?\n");
            ...
            System.out.print("you've chosen to quite, exiting now, please return later to complete the survey");
            return;
        }
    }
